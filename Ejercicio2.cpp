...
void menu(){
	...
	cout<<"Ingrese el nombre que le desea colocar a su archivo: ";
...
void ingresardatos(string na){
	...
	if(archivo.fail()){
		cout<<"No se pudo abrir el archivo intente de nuevo";
		exit(1);
	}
...
void leer_archivo(){
	...
	for (int i = 0; i < lineas; i++)
    {
        if (!archivo)
        {                                               
            cerr << "No se puede abrir el archivo intente de nuevo" << endl;
            system("PAUSE");
        }
